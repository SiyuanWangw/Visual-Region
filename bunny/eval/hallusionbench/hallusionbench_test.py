...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_file", type=str, default="/inspire/hdd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/wangdianyi-240107110022/Bunny-main/bunny/eval/hallusionbench/incorrect/incorrect.jsonl", help="Path to the output file to store the incorrect predictions")
    parser.add_argument("--csv_file", type=str, default="/inspire/hdd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/wangdianyi-240107110022/Bunny-main/bunny/eval/hallusionbench/experiments.csv", help="Path to the output csv file to store the experiment data")
