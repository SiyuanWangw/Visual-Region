...
def process(line, args, tokenizer, image_processor, image_processor_aux ,model_config):
    qs = line["question"]
...
def eval_model(args):
    ...
    for line in tqdm(questions, total=len(questions)):
        ...
        input_ids, image_tensor, image_tensor_aux ,image_sizes, prompt = process(line, args, tokenizer, image_processor,image_processor_aux ,model.config)
